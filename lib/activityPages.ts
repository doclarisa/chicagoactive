// Stage 2 Wave 2 — the activity tags that cleared the metro-wide 10+
// gate (see lib/activities.ts for the full 26-tag internal vocabulary).
// Phase 3 added languages (grew from 6 to 14 listings, clearing the gate);
// lifelong-learning (32) deliberately stays excluded — it's a routing hub
// (/classes-for-seniors) rather than a flat listing page, at any level.
...
export const ACTIVITY_PAGES: ActivityPageDef[] = [
  ...
  },
  {
    ...
    intro:
      "Round Lake Area Park District's Senior Activities program runs chair yoga, Zumba Gold, and seated Strength and Stretch out of the Robert W. Rolek Community Center, and Skokie Park District's Active Adults hub adds Tai Chi Chih plus both Active Adult and Deep Water Aerobics at the pool — two of 83 fitness listings spanning every county.",
  },
  {
  ...
  },
  {
    ...
    intro:
      "The Centre at North Park gives you a free first lunch as part of Franklin Park's weekday senior lunch program, and Evanston's Levy Senior Center serves a weekday congregate lunch for a suggested $5 donation — two of 65 senior lunch programs running on a suggested-donation or low-cost basis across the region.",
  },
  {
    ...
    intro:
      "Oak Lawn Park District's renovated Memorial Activity Center added a dedicated senior wing for bridge and pinochle in 2025, and Cary Park District runs a $5-ante Game Club covering Golf, No Sevens, Bunco, and UNO — a sample of 72 card and game programs, including pinochle (19 listings), mahjong (17), bridge (13), and canasta (11).",
  },
  {
    ...
    intro:
      "The Park District of Oak Park's Dole Center runs ceramics, stained glass, and weaving classes, and Cary Park District's senior hub adds its own art programming alongside a weekly Walking Club — a sample of 55 art programs, from drawing and painting to quilting and jewelry-making.",
  },
  {
    ...
    intro:
      "Chicago Ridge Park District runs both a standard Senior Bingo night and a music-themed \"Music Bingo\" session as part of its Actively Aging series, and Zion Park District pairs Bingo and Lunch several times each summer — two of 49 bingo nights across the region, most free or under $5.",
  },
  {
  ...
  },
  {
    ...
    intro:
      "Round Lake Area Park District runs chair yoga inside its Fluid Movement/Tai Chi block at the Robert W. Rolek Community Center, and Ridgeville Park District in Evanston runs a seated-friendly class entirely over Zoom for anyone who'd rather join from home — two of 44 yoga listings across the region.",
  },
  {
    ...
    intro:
      "Plainfield Public Library runs a quarterly rotation of core technology classes plus one-off sessions on Google Suite and 3D printing, and Chicago's DFSS Regional Senior Centers build computer instruction into their standard program menu at all six regional sites — a sample of 30 computer-class listings.",
  },
  {
  ...
  {
    slug: "language-classes-for-seniors",
    tag: "languages",
    h1: "Language Classes for Seniors in Chicagoland",
    intro:
      "Skokie Public Library's Mango Languages access covers 60+ languages for its Adult Learners program, and Indian Prairie Public Library in Darien pairs ESL instruction with citizenship preparation and genealogy research help — two of 14 language-learning listings across the region, most folded into a library's wider adult-services programs rather than run as standalone classes.",
  },
];
